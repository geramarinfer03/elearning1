                    ...
                    <div class="col-md-12">
                        ...
                        <table id="main_table" class="display table table-hover" style="border: 1px dotted red;">
                            ...
                            <tbody id="sem{{$semana->id_semana}}_row0" class="main_table_seccion">
                                ...
                                <tr>
                                    <td>
                                        <table id="main_table{{$recurso->id_recurso}}" class="display table table-hover conB">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <label class="hiddenclass" id="label{{$recurso->id_recurso}}" for="inpSem{{$recurso->semana}}res{{$recurso->id_recurso}}">Notas Seccion </label>
                                                        <input name="" id="{{$recurso->id_recurso}}" class="box-title inputS inp{{$recurso->id_recurso}}" type="text" value="{{$recurso->notas}}" 
                                                               disabled />
                                            ...
                                            <tbody id="sem{{$recurso->semana}}_row{{$recurso->id_recurso}}" class="main_table_seccion">
                                        </table>
                                    </td>
                                ...
                                @endif
                                 ...
                                 @if($recurso->tipo_recurso == 4)

                                <tr>
                                    <td>
                                        <label for="inpSem{{$recurso->semana}}res{{$recurso->id_recurso}}">Texto</label>
